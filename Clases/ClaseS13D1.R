# Key Mtz
# Clase semana 13 dia 1 
# Ejercicio Correlacion 

semillas <- read.csv("Clases/BaseDeDatos_estadistica.csv")

#Revisar medienate una grafica si existe una asociacion entre el diametro de la semila y la longitud
...
y1 <- c(9.14, 8.14, 8.74, 8.77, 9.56, 8.10, 6.13, 3.10, 9.13, 7.26, 4.74)
